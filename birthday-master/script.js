...
const nomor_hp_yang_ngirim = "+628978211567"
const nama_yang_ngirim = "Fadhlan gip"

// nama 
const nama = "Wawaaa❤️❤️💐"
...
const kata = [
  ...
  `Jaga kesehatan yaaa soalnya kita jauh 365km🙃`,
  `Maaf aku selalu bikin repot kamu ${nama}`,
  `Jangan lupa di makan 🍰 nya, walau virtual hehe`,
  `Sekali lagi HBD ${nama} 🙌✨` 
]
